          ...
          "
            >
              ...
              <div className="py-16  md:px-24  lg:py-10">
                <div className="flex flex-col-reverse items-center justify-center lg:flex-row gap-12">
                      ...
                      <div className="mb-1 sm:mb-2">
                        ...
                        <div className='relative mb-3'>
                          ...
                          <input
                            ...
                            type="file"
                            className="py-3 w-full bg-white border border-gray-300 rounded-full shadow-sm flex-grow px-4  transition duration-200 placeholder:text-black font-medium  outline-none pl-12 bg-none hidden"
                          />
